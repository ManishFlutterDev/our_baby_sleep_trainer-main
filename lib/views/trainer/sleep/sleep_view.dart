               ...
               Container(
                 ...
                 decoration: BoxDecoration(
                   ...
                   // border: Border.all(color: Colors.grey.shade200),
                     image: DecorationImage(image: AssetImage("assets/images/curve_background.png"),fit: BoxFit.fill)
                 ),
                 child: Column(
                             ...
                             child: Column(
                               ...
                               children: [
                                   ...
                                   builder: (context, mode) => RichText(
                                     text: TextSpan(
                                       children: [
                                         TextSpan(
                                           text: 'Baby is\n',
                                           style: GoogleFonts.lato(fontSize: 24,color: Color(0xFF000000),fontWeight: FontWeight.w400),
                                         ),
                                         ...
                                         TextSpan(
                                           ...
                                           style: GoogleFonts.inter(fontSize: 30,color: Color(0xFF000000),fontWeight: FontWeight.w900),
                                 ...
                                 Text(
                                   ...
                                   style: GoogleFonts.lato(fontSize: 17,color: Color(0xFF000000),fontWeight: FontWeight.w400),
                                 ),
                               ],
                             ),
                           ),
